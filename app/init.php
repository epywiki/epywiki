...
require_once __DIR__ . '/models/EpiDataModel.php';
...
require_once __DIR__ . '/controllers/EpiDataController.php';
...
if (count_users() === 0 && ($_GET['page'] ?? '') !== 'install_admin') {
    header("Location: index.php?page=install_admin");
    exit;
}
